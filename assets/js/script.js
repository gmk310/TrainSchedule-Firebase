$(document).ready(function() {
  ...
  console.log("Firebase Database", dataRef);
  var editTrainKey = "";
  var fbTime = moment();
  var newTime;
  ...
  dataRef
    ...
    .on(
      "value",
      function(snapshot) {
        console.log("VALUE EVENT from Firebase");
        $("tbody").empty();
  ...
  dataRef
    ...
    .on(
      ...
      function(childSnapshot) {
        console.log("CHILD CHANGED from Firebase");
        var trainClass = childSnapshot.key;
        var trainId = childSnapshot.val();
        var firstTimeConverted = moment.unix(trainId.trainTime);
        var timeDiff = moment().diff(
